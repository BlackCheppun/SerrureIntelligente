import { Modal, Pressable, StyleSheet, TextInput, TouchableWithoutFeedback, useColorScheme, View } from "react-native";
...
export default function AddLockModal({ visible, setVisible, onClose, identifier, setIdentifier, password, setPassword, label, setLabel }: AddLockModalProps) {
